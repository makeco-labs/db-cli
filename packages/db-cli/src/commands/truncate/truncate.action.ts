...
/**
 * Executes database truncate with CLI output (delete data, keep structure)
 */
export async function executeTruncateDatabase(config: Config): Promise<void> {
  console.log('\nTruncating database data...');
