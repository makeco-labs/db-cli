...
export type ActionKey = 'generate' | 'migrate' | 'studio' | 'drop' | 'push' | 'reset' | 'refresh' | 'check' | 'seed' | 'truncate';
 ...
 */
export async function determineAction(actionInput?: string): Promise<ActionKey> {
